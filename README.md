...
> Independent analysis project on a retail sales dataset. Data source: [FILL — dataset name + link; confirm licence before committing the .pbix or any data].
...
Retail transaction data with order dates, region/city, product sub-categories, customer segments, sales and profit fields. [FILL — period covered, row count.]
...
```
dashboard.pbix        (committed only if the data licence permits)
screenshots/          full-page and per-visual captures
README.md
```
